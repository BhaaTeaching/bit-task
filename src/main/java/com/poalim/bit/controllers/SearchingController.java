...
public class SearchingController {
    ...
    public ResponseEntity<List<WordsResponseDto>> searchWords(@RequestBody TextRequestDto textRequestDto) throws IOException, ExecutionException, InterruptedException {
